...
class LSTM(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, output_dim=1, num_layers=2, dropout=0.0):
        # input_dim : 13 + 1149, hidden_dim : 512
        # output_dim : 28, num_layer : 2
    ...
    def forward(self, input):
        ...
        # lstm_out : [Batch, Seq, hidden_dim] = [100, 22, 512]
        # hidden : (h_n, c_n) # ([2, 100, 512], [2, 100, 512])
        
        # Final layer 
        y_pred = self.linear(lstm_out) # [Batch, Seq, output_dim] = [100, 22, 28]
        return y_pred
...
class Transformer(nn.Module):
    ...
    def forward(self, src): # [Batch, Seq, Feature]
