...
def build(x_channels, cond_channels, control_shape, autoreg_shape, hparams, is_training):
    ...
    graph = Glow(x_channels, cond_channels, control_shape, autoreg_shape, hparams)
